...
public class ToolBreakWarning extends LabyModAddon {
    ...
    protected void fillSettings(List<SettingsElement> list) {
        final BooleanElement formatBool = new BooleanElement("Format Numbers", new ControlElement.IconData(new ResourceLocation("prevtb/textures/format.png")), new Consumer<Boolean>() {
        ...
        final BooleanElement warnOnLastHit = new BooleanElement("Warn on last hit", new ControlElement.IconData(new ResourceLocation("prevtb/textures/0p.png")), new Consumer<Boolean>() {
        ...
        final BooleanElement debugBool = new BooleanElement("Debug Mode (Development Feature)", new ControlElement.IconData(new ResourceLocation("prevtb/textures/matrix.png")), new Consumer<Boolean>() {
        ...
        final StringElement warnmsg = new StringElement("Warn Message", new ControlElement.IconData(Material.REDSTONE_TORCH_ON), warnMsg, new Consumer<String>() {
        ...
        final SliderElement swordSlider = new SliderElement("Sword Warn Percentage",
                new ControlElement.IconData(Material.IRON_SWORD), warnPercentageSword);
        final SliderElement pickSlider = new SliderElement("Pickaxe Warn Percentage",
                new ControlElement.IconData(Material.IRON_PICKAXE), warnPercentagePickaxe);
        final SliderElement axeSlider = new SliderElement( "Axe Warn Percentage",
                new ControlElement.IconData(Material.IRON_AXE), warnPercentageAxe);
        final SliderElement spadeSlider = new SliderElement( "Shovel Warn Percentage",
